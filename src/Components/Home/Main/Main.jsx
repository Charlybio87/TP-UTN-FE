          ...
          <div className='container-main'>
            <div className='main-info'>
              <div className='main-info-text-1'>
                ...
                <ul className='main-info_items'>
                  <li className='items_arrows'>
                    <i class="bi bi-arrow-right-circle"></i>
                    <a className='items' href="http://">Certificación oficial de la Specialty Coffee Association</a>
                  </li>
                  <li className='items_arrows'>
                    <i class="bi bi-arrow-right-circle"></i>
                    <a className='items' href="http://">Certificación oficial de la Specialty Coffee Association</a>
                  ...
                  <li className='items_arrows'>
                    <i class="bi bi-arrow-right-circle"></i>
                    <a className='items' href="http://">Talleres personalizados para profesionales de la hostelería</a>
                  </li>
                </ul>
              </div>
              <div className='main-info-img'>
                <img className='img_ppl_1' src={img_coffe1} alt="1" />
              </div>
            </div>
            <div className='main-info main-info-inf'>
              <div className='main-info-img'>
                <img  className='img_ppl_2' src={img_coffe2} alt="2" />
              </div>
